...
from .utils.ProcessQueryWithPhrase import process_query
...
class SearchAPI(Resource):
    def post(self):
        ...
        global col_len, collection, inv_index, ps, STwords, col_nolyrics, terms_index, bm_avg, docs
        try:
            ...
            if type =="boolean" or type=="ranked" or type=='ranked_bm':
                ...
                response = process_query(query=query, qtype=type, col_len=col_len, 
                            collection=col_nolyrics, inv_index=inv_index, ps=ps, STwords=STwords, bm_index=terms_index, bm_avg=bm_avg, docs=docs)
